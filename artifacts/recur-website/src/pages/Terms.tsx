        ...
        <div className="prose prose-neutral max-w-none space-y-10 text-foreground">
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>You are at least 18 years old or have parental consent</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>You will use the service responsibly</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>You understand that Recur is not a substitute for professional medical advice</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Maintaining the security of your account</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>All activities that occur under your account</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Providing accurate information</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Use Recur for any unlawful purpose</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Share your account with others</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Attempt to access other users' accounts</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Interfere with the proper functioning of the service</li>
            </ul>
          </section>
