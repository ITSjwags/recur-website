        ...
        <div className="prose prose-neutral max-w-none space-y-10 text-foreground">
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Name and email address</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Workout preferences and history</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Information about injuries or pain points you choose to share</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Device information for app functionality</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Provide, maintain, and improve our services</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Personalize your workout experience</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Send you updates about Recur (you can opt out anytime)</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Respond to your comments and questions</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Access the personal information we hold about you</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Request correction of inaccurate information</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Request deletion of your information</li>
              <li className="flex gap-2"><span className="text-primary mt-1.5">•</span>Opt out of marketing communications</li>
            </ul>
          </section>
